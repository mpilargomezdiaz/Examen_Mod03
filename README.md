...
```
- Crea, usando docker-compose un contenedor que permita hacerle peticiones a la API, puedes hacerlo en Windows, obtén capturas del proceso en las que se pueda ver que funciona.
